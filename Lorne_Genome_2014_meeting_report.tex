...
\author[addressref={aff1,aff2},noteref={n1},email={hickey@wehi.edu.au}]{\inits{PFH}\fnm{Peter F} \snm{Hickey}}
\author[addressref={aff3,aff4},noteref={n1},corref={aff3},email={mark.robinson@imls.uzh.ch}]{\inits{MDR}\fnm{Mark D} \snm{Robinson}}
...
% http://goo.gl/rK999U http://lornegenome.org/program/
...
% http://goo.gl/mosjVm [NYTIMES] http://www.nytimes.com/2012/07/08/health/in-gene-sequencing-treatment-for-leukemia-glimpses-of-the-future.html?pagewanted=1&_r=2&hp
...
Life Research is to commended for providing delegates with proper barista-style coffee. In addition, the Walter and Eliza Hall Institute of Medical Research is to be thanked for their ongoing support of the Parent's Viewing Room.  We hope to see this family-friendly model exported to conferences elsewhere.
