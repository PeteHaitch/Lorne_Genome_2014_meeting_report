...
\author[addressref={x1,x2},noteref={n1},email={hickey@wehi.edu.au}]{\inits{PFH}\fnm{Peter F} \snm{Hickey}}
\author[addressref={x3,x4},noteref={n1},corref={x3},email={mark.robinson@imls.uzh.ch}]{\inits{MDR}\fnm{Mark D} \snm{Robinson}}
...
\note[id=n1]{Equal contribution} % note, connected to author
\end{artnotes}
